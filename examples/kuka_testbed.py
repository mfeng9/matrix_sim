...
from pybullet_tools.utils import WorldSaver, enable_gravity, connect, dump_world, set_pose, \
    ...
    BLOCK_URDF, STOVE_URDF, load_model, wait_if_gui, disconnect, DRAKE_IIWA_URDF, wait_if_gui, update_state, disable_real_time, HideOutput
...
def main(display='execute'): # control | execute | step
    """
    NOTE: the collision checker can occasionally ignore collisions, this is because the collision
    object of the kuka arm is obj mesh. May become better with primitives (e.g. cyinders)
    """
    ...
    set_pose(stove, Pose(Point(y=0.5, z=stable_z(block, floor)+0.5)))
